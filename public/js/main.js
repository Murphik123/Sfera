// ============================================================
// ЕДИНЫЙ СЛОВАРЬ ПЕРЕВОДОВ (TM, RU, EN)
// ============================================================
const translations = {
    tm: {
        logo_title: "SFERA",
    ...
    ru: {
        ...
        hero_text: "Современная государственная цифровая экосистема, объединяющая электронную торговлю, интеллектуальную аналитику, финансовые услуги и документооборот.",
    ...
    en: {
        ...
        hero_text: "A modern state digital ecosystem combining e-commerce, AI analytics, financial services, and document workflow.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (langBtn) {
        langBtn.addEventListener('click', () => {
            const cycle = ['tm', 'ru', 'en'];
            let idx = cycle.indexOf(currentLang);
            idx = (idx + 1) % cycle.length;
            setLanguage(cycle[idx]);
        });
    }
